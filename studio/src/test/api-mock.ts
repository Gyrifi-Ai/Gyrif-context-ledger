...
export function resetApiMock(): void {
  ...
  mockApi.status.mockResolvedValue({ status: "ok", version: "test", commit: "test-commit", buildDate: "2026-09-01T00:00:00Z", inference: "disabled", health: { database: "ok", target: "unknown", inference: "disabled", inferenceState: "disabled", unresolvedIntents: 0 } });

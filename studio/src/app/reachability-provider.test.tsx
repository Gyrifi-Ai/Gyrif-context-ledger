...
describe("ReachabilityProvider", () => {
  it("moves from a transport outage to connected on explicit retry", async () => {
    mockApi.status.mockRejectedValueOnce(new Error("connection refused")).mockResolvedValue({ status: "ok", version: "1.2.3", commit: "abc123", buildDate: "2026-09-01T00:00:00Z", inference: "disabled", health: { database: "ok", target: "unknown", inference: "disabled", inferenceState: "disabled", unresolvedIntents: 0 } });
